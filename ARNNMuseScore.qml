...
MuseScore {
    id: mainMuseScoreObj
    menuPath: "Plugins.arnnMuseScore"
    description: qsTr("This plugin calls the Anticipation-RNN.")
    pluginType: "dock"
    dockArea:   "left"
    ...
    FileIO {
        id: myFile
        source: tempPath() + "/" + mainMuseScoreObj.curScore.title + "_recomposed_by_arnn.xml"
